...
typename SgmDisparityComputer<IT, CC>::MeanMethod SgmDisparityComputer<IT, CC>::getMeanMethod() const
{
    return meanMethod;
}
...
template<typename IT, typename CC>
typename SgmDisparityComputer<IT, CC>::CostMethod SgmDisparityComputer<IT, CC>::getCostMethod() const
{
    return costMethod;
}
